...
urlpatterns = patterns('',
    ...
    url(r'lastrequests/$', views.web_runner_lastrequests, name='web_runner_lastrequests'),
    url(r'lastrequests/(?P<n>\d+)/$', views.web_runner_lastrequests, name='web_runner_lastrequests'),
)
