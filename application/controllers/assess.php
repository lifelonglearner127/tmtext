    ...
    private function build_asses_table($results, $build_assess_params, $batch_id = '') {
        ...
        if ($build_assess_params->max_similar_item_count > 0) {
            ...
            for ($i = 1; $i <= $max_similar_item_count; $i++) {
              ...
              $columns[] = array("sTitle" => "Words","sClass" => "Meta_Description_Count".$i, "sName" => 'Meta_Description_Count' . $i);
            }
...
//        echo $_POST['batch_id'] . ' - ' . $_POST['batch_compare_id'];die;
...
//                short_description_wc
                foreach($results as $data_row){
                    $snap_data[$key][] = (int)$data_row->short_description_wc;
                }
