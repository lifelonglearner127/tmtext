...
|
*/
$config['base_url']	= 'http://dev.contentanalyticsinc.com/producteditor/';
...
|
*/
$config['encryption_key'] = 'cCR8deEcURGiXyy1+Y9mFSD5USOxn59lkE4sWL0aoJU=';
...
$config['cmd_mask'] = '{1}';
$config['cmd_path'] = '/var/www/dev.trillionmonkeys.com/web/producteditor';//'/opt/trillionmonkeys.com/tm';
$config['attr_path'] = $config['cmd_path'].'/webroot';
