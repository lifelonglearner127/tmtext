...
class hunspell {
	...
	private $allowedLanguages = array("en_US");

	private $response = array();


	public function __construct($input = null, $language = null){
		if($language != null && in_array($language, $this->allowedLanguages) == true) $this->language = $language;

		if ($input != null) $this->check($input);
	}
