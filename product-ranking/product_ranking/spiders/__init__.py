...
# ****************************************************************************
# The next lines SHOULD NOT be here, they should be moved in a subdirectory
#  called 'monitoring' or so. The only reason of having this code here is
#  because Scrapyd can't find the code in a subdirectory; that's weird and
#  probably related to EGG packaging.
# I'm giving up after hours of debugging. EGGs are evil.
# TODO: move the code below to a proper place.
import socket
