var RR = function(href, id, RSobjs) {
...
function r3_common(RR_entity) {
    ...
    this.setBaseUrl = function (baseUrl) {
        if ('httthis.setApiKey = function (apiKey) {
    //    this.apiKey = apiKey;
    //};p://media.richrelevance.com/rrserver/' == baseUrl) {
...
function main(url, product_id, RSobjs){
    rr = new RR(url, product_id, RSobjs);
    return rr.js();
}