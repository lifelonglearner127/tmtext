...
from walmart_api.views import InvokeWalmartApiViewSet, ItemsUpdateWithXmlFileByWalmartApiViewSet, ItemsUpdateWithXmlTextByWalmartApiViewSet, CheckFeedStatusByWalmartApiViewSet
