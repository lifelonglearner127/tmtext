...
from walmart_api.serializers import WalmartApiItemsRequestJsonSerializer, WalmartApiFeedRequestJsonSerializer
...
class InvokeWalmartApiViewSet(viewsets.ViewSet):
    ...
    """
    serializer_class = WalmartApiItemsRequestJsonSerializer
...
class ItemsUpdateByWalmartApiViewSet(viewsets.ViewSet):
    """
    API endpoint that allows groups to be viewed or edited.
    """
    serializer_class = WalmartApiItemsRequestJsonSerializer
...
class CheckFeedStatusByWalmartApiViewSet(viewsets.ViewSet):
    ...
    API endpoint that allows groups to be viewed or edited.
    """
    serializer_class = WalmartApiFeedRequestJsonSerializer
