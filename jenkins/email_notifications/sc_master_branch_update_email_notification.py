...
toaddrs = ["jacob.cats426@gmail.com", "diogo.medeiros1115@gmail.com", "support@contentanalyticsinc.com", "no.andrey@gmail.com"] # must be a list
subject = "Master SC Scrapers Updated"
msg = """\
From: %s
To: %s
Subject: %s
