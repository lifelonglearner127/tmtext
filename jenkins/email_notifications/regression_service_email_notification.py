...
for website in website_list:
    ...
    website_header = "- " + website + "\n" + "Total tested product numbers: %d\n" \
                                             ...
                                             "Possibility of 80% of product titles are < 2 characters long: %s\n" \
                                             "Possibility of 80% of review counts are 0: %s\n" \
                                             "Possibility of 80% of product descriptions are < 2 words long: %s\n" \
                                             "Possibility of 80% of image counts are 0: %s\n" \
                                             "Possibility of 80% of products are out of stock: %s\n" \
