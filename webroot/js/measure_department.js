...
$( function() {
    ...
    $("#board_view").click(function(e) {
        ...
        if($('.board_view').css('display') == 'none'){
            $('.dashboard').hide();
            $.post(base_url + 'index.php/measure/getBoardView', {'site_name': $("#hp_boot_drop .btn_caret_sign").text(), 'ch_val': 'all'}, function(data) {
                $('.board_view').html(data);
    ...
    $("#board_view_filter_cnt select").bind('change', function(e) {
        ...
        $.post(base_url + 'index.php/measure/getBoardView', {'site_name': $("#hp_boot_drop .btn_caret_sign").text(), 'ch_val': ch_val}, function(data) {
            $('.board_view').html(data);
            $('.board_view .board_item img').on('click', function() {
                var dm_id = $(this).parent().find("input[type='hidden'][name='dm_id']").val();
                $.post(base_url + 'index.php/measure/get_board_view_item_data', {'dm_id': dm_id}, function(data) {
...
function showBoardItemPreviewModal(data) {
    ...
    $("#preview_board_item_modal").css('width', '850px');
