...
class SearchSpider(BaseSpider):
	...
	def __init__(self, product_name = None, product_url = None, product_urls_file = None, target_site = None, output = 1, threshold = 0.65, outfile = "search_results.txt", fast = 1):
