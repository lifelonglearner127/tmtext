...
CREATE TABLE `reports` (
  ...
  `cover_page_order` enum('First','Second','Second to Last','Last') NOT NULL DEFAULT 'First',
  `cover_page_layout` enum('Landscape','Portrait') NOT NULL DEFAULT 'Landscape',
  `cover_page_body` text NOT NULL,
  `recommendations_page_name` varchar(100) NOT NULL,
  `recommendations_page_order` enum('First','Second','Second to Last','Last') NOT NULL DEFAULT 'First',
  `recommendations_page_layout` enum('Landscape','Portrait') NOT NULL DEFAULT 'Landscape',
  `recommendations_page_body` text NOT NULL,
  `about_page_name` varchar(100) NOT NULL,
  `about_page_order` enum('First','Second','Second to Last','Last') NOT NULL DEFAULT 'First',
  `about_page_layout` enum('Landscape','Portrait') NOT NULL DEFAULT 'Landscape',
