...
class WalmartGroceryScraper(Scraper):
    ...
    INVALID_URL_MESSAGE = 'Expected URL format is http://grocery.walmart.com/.*/product-detail.jsp?skuId=<prod-id>'
    ...
    def check_url_format(self):
        m = re.match(r'^http://grocery\.walmart\.com/.*/product-detail\.jsp\?skuId=\d+$', self.product_page_url, re.U)
        return bool(m)
