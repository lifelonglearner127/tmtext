    ...
    def _variants(self):
        ...
        if variants:
            ...
            for variant in variants:
                variant_stock_status_url_list.append(self._make_variant_stock_status_request_url(product_id, variant))
                ...
                for sub_index in range(len(response_list)):
                    try:
                        ...
                        if stockstatus_json["availabilityStatus"] == "true":
                            variants[chunk_size * index + sub_index]["in_stock"] = True
                        else:
                            variants[chunk_size * index + sub_index]["in_stock"] = False
                    except Exception, e:
                        variants[chunk_size * index + sub_index]["in_stock"] = False
