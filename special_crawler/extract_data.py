...
class Scraper():
    ...
    BASE_DATA_TYPES_LIST = {
            ...
            "style", # list of style string
            "flavor", # list of flavor string
            "variants", # list of variants
            "selected_variants", # list of selected variants
            "price_for_variants", # list of dictionary of price for variants
            "stockstatus_for_variants", # list of dictionary of stock status for variants
            # page_attributes
    ...
    DICT_STRUCTURE = {
        ...
        "page_attributes": ["mobile_image_same", "image_count", "image_urls", "video_count", "video_urls", "wc_360", \
                            ...
                            "image_hashes", "thumbnail", "sellpoints", "canonical_link", "color", "size", "color_size_stockstatus", "style", "flavor", "variants", "selected_variants", "price_for_variants", "stockstatus_for_variants"], \
